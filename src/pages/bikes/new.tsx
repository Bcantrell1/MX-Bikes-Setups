...
export default function CreateBikePage() {
  ...
  return (
    <div className="h-screen flex justify-center items-center">
      ...
      >
        {error && error.message}
        <label className="text-gray-700 font-bold py-2" htmlFor="name">
          Name
        </label>
        <input
        ...
        <input
          className="text-gray-700 shadow border rounded border-gray-300 focus:outline-none focus:shadow-outline py-1 px-3 mb-6"
          type="text"
          placeholder="Bike Category"
          {...register("category")}
        />
        <button className="bg-orange-600 hover:bg-orange-800 text-white font-bold rounded py-2 px-4">
          Create bike
        </button>
      </form>
    </div>
